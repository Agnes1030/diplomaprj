package com.febs.common.utils.poi;

import com.csvreader.CsvWriter;
import com.febs.common.annotation.ExportConfig;
import com.febs.common.utils.poi.convert.ExportConvert;
import com.febs.common.utils.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.febs.common.utils.poi.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.febs.common.utils.poi.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
