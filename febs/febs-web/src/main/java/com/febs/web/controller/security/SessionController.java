...
import com.febs.common.utils.AddressUtils;
...
import com.febs.web.domain.UserOnLine;
...
public class SessionController {
    ...
    public String online() {
        return "admin/system/monitor/online";
    }
    ...
    public void sessionInvalid(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        // session 失效后直接跳转到登录页
        redirectStrategy.sendRedirect(request, response, securityProperties.getMemberLogin());
    }
