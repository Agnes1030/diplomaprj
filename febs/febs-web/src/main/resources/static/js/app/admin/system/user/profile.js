...
$(function () {
    ...
    $(".default_avatars_list").find("img").each(function () {
        ...
        $this.on("click", function () {
            ...
            $.post(ctx + "admin/user/changeAvatar", {"imgName": target_src}, function (r) {
                if (r.code === 0) {
    ...
    $("#update-profile .btn-save").click(function () {
        ...
        if (flag) {
            $.post(ctx + "admin/user/updateUserProfile", $userProfileForm.serialize(), function (r) {
                if (r.code === 0) {
...
function refreshUserProfile() {
	window.location.href=ctx + "admin/user/profile";
}

function editUserProfile() {
    $.post(ctx + "admin/user/getUserProfile", {"userId": userId}, function (r) {
        if (r.code === 0) {
