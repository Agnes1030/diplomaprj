...
$(window).on("load", function () {
    ...
    $.post(ctx + "admin/menu/getUserMenu", {"userName": userName}, function (r) {
        if (r.code === 0) {
            var data = r.msg;
    ...
    $("body").on("change", ".theme-switch input:radio", function () {
        ...
        $.get(ctx + "admin/user/theme", {"theme": a, "username": userName}, function (r) {
    ...
    $("#user__profile").on('click', function () {
        $.post(ctx + "admin/user/profile", function (r) {
